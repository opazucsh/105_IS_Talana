...
url = "https://talana.com/es/api/banco/"
...
def mi_funcion(registro):
    return {  
        ...
        "codigo_transfer" : registro["codigo_transfer"] 
...
df_talana = df.to_sql("Talana_Banco_paso", schema='dbo', con=engine, if_exists="replace")
print("correcto")
